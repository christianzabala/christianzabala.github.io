...
**NOTE:**  I will not be sharing the Interview questions on this post since I have signed a NDA and for sure I'm not an expert engineer yet so all of this is just my own opinion so it's also better if you have a friend that already has a lot of experienced on the networking field that you can ask for questions or advice. My Experience might be different from others since AWS Network development engineers has different teams. 
{: .notice--info}
